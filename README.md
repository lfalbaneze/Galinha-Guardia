...
A tela inicial tem uma cena própria de fazenda em pixel art: celeiro, silo, horta e terreiro. O nome aparece sobre o céu e os controles ficam numa placa lateral, com disposição vertical em telas menores. Os sprites passeiam por trajetos traçados no chão de terra da imagem, sem atravessar cercas ou hortas, e reagem a “Mexer com a turma”; a aparência equipada também aparece no terreiro. Cenário e animais compartilham o mesmo recorte, escala e movimento suave do ponteiro. A escala dos bichos acompanha a profundidade, as patas ficam ancoradas no chão e os mais próximos são desenhados por último. Tudo respeita movimento reduzido, pausa fora do menu e não altera a simulação nem o salvamento. A arte e seu prompt estão em [assets/menu/ART-NOTES.md](assets/menu/ART-NOTES.md). As chaves antigas de progresso foram preservadas.

O mapa usa peças de cenário em pixel art para combinar com os personagens: celeiro, galinheiros, silos, árvores, moitas, feno e cercas. O chão tem textura procedural, bordas irregulares nas trilhas e tons próprios para curral, milharal, horta e pomar. A textura é calculada uma vez por fazenda e reutilizada enquanto a câmera se move. O refúgio é um terreiro de terra com seis ninhos de palha. A geração, as colisões e os salvamentos mantêm os mesmos dados; a arte não cria obstáculos invisíveis. [Arte original e prompt](assets/farm/ART-NOTES.md).

Cada amigo resgatado aumenta de imediato a velocidade real, a visão, a abertura do campo de visão e a duração de busca do lobo, além de reduzir seu tempo de reação. Os nomes dos quatro níveis continuam, mas não há mais intervalos de resgates sem aumento de dificuldade. Os tetos também avançam aos poucos: mesmo perto do final, cada resgate aumenta a pressão, preservando uma vantagem de velocidade para a corrida da galinha. O HUD mostra o **Cerco**; os avisos de resgate mostram pontos e progresso.

Os seis pintinhos são **bônus opcionais dentro de alguns esconderijos** de feno, árvores e arbustos. A escolha usa a semente da fazenda e preserva a geografia; a maioria dos esconderijos fica vazia. A menos de 280 px, um piado e a placa compacta **Piu-piu…** apontam a cobertura. A pista atravessa o próprio feno, mas respeita paredes e cercas. Entre com **E** e segure **C por 0,85 segundo**: o pintinho amarelinho aparece numa animação, rende **100 pontos** e vai direto para o ninho. Correr por cima, investigar do lado de fora, usar outro esconderijo ou pausar não concede o bônus; se o lobo viu a entrada, é preciso escapar antes. Cada bônus só pode ser recebido uma vez. O contador **0/6**, as instruções e os requisitos das aparências ficam visíveis desde o início. **Salvar os dez amigos conclui a missão mesmo sem pintinhos**; a celebração inclui somente os encontrados. Procure os bônus antes de salvar o último amigo para conquistar todas as aparências.
...
**Os animais usam gravações:** mugidos, latidos, miados, grasnados, grunhidos, balidos, zurros, cacarejos e piados. O coelho tem o ruído discreto de mastigação de um coelho real. As 12 vozes locais ficam em `assets/audio/voices/v2`, com [autores, licenças e players para escuta](assets/audio/CREDITS.html). Galinha, cabra e cachorro receberam novas amostras; a pasta versionada evita reutilizar áudio antigo em cache. Os cortes preservam a afinação e têm volume normalizado, sem saturação. A música baixa para 24% do volume escolhido enquanto uma voz toca, voltando ao volume anterior ao terminar. As reações próximas dos animais também acionam sua voz, com o mesmo intervalo das falas.
...
O áudio da partida começa após clicar em **Começar**, **Continuar** ou **Reiniciar**. No menu, **Mexer com a turma** alterna entre os animais visíveis: o escolhido dá um pulo de 0,65 segundo e toca sua gravação. A fala aparece junto dele por 1,8 segundo, a sombra permanece no chão e a aparência equipada determina o som da protagonista. Cliques rápidos reutilizam um único player, sem acumular vozes. Movimento reduzido mantém a fala e o som, sem o pulo. Essa interação respeita o volume de efeitos e o silêncio, sem iniciar a música nem avançar o jogo salvo.

Pausar, sair da janela ou ocultar a página interrompe o som e a partida; entrar no jogo encerra a chamada do menu. Ao continuar, os efeitos já tocados não se repetem. Os arquivos WAV são locais e funcionam sem internet; não há dependências de áudio externas.
