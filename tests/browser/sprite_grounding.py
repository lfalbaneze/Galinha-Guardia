...
def check_sprite_grounding(page):
    ...
    result = page.evaluate("""() => {
      ...
      function bottom(){const data=c.getImageData(0,0,240,240).data;
      ...
      for(const name of ['wolf','chicken','dog','cat','cow','goose']){
      ...
      const board=document.createElement('canvas');board.id='spriteGroundingReview';board.width=1080;board.height=380;
      board.style.cssText='position:fixed;left:0;top:0;z-index:2147483647;width:1080px;height:380px;';
      document.body.append(board);const b=board.getContext('2d');
      b.fillStyle='#78944f';b.fillRect(0,0,1080,380);
